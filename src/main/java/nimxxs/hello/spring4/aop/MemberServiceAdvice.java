...
import nimxxs.hello.spring4.controller.BoardController;
...
public class MemberServiceAdvice {
    ...
    @Pointcut("execution(* nimxxs.hello.spring4.controller.MemberController.myinfo(..))")
    public void myInfoPoint() {}

    @Pointcut("execution(* nimxxs.hello.spring4.controller.MemberController.join(..))")
